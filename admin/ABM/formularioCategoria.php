...
if(isset($_POST['submit'])){
  if(!empty($_GET['edit'])){
      ...
      businessGuardarCategorias($_POST);
  }
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Agregar/Editar Categorias</h3>
							</div>
							<div class="module-body">
									...
									<form class="form-horizontal row-fluid" action="" method="post">
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="basicinput" name="nombre" value="<?php echo $categoria['nombre']?>"  class="span8">
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="basicinput" name="subcategoria" value="<?php echo $categoria['subcategoria']?>" class="span8">
										...
										<div class="control-group">
											...
											<div class="controls">
												<textarea class="span8" name="descripcion" rows="5"> <?php echo $categoria['descripcion']?> </textarea>
											</div>
										</div>
